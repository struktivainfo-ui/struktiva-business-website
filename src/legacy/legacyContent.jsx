...
function HomeLegacyContinuation({
  ...
  skipContactSection = false,
} = {}) {
  return (
    <>
      {!skipServiceTicker ? <HomeServiceTickerSection /> : null}
      ...
      {!skipContactSection ? <HomeContactSection /> : null}
    </>
  )
}
...
export {
  AboutPage,
  DatenschutzPage,
  DemoDienstleisterHtmlPage,
  DemoHandwerkerHtmlPage,
  DemoKosmetikHtmlPage,
