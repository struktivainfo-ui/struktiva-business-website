  ...
  handwerker: {
    ...
    sections: [
      ...
      },
      {
        ...
        points: ['regionale Ausrichtung', 'klare KontaktmÃ¶glichkeiten', 'Bewertungsbereich als Beispiel', 'Vorher-Nachher-Bereich', 'WhatsApp- oder Telefon-CTA'],
      },
    ],
...
const whyPoints = [
  ...
  'Website, Landingpage, WhatsApp, Google, Social Media und Newsletter als zusammenhÃ¤ngende Struktur',
...
function useDocumentTitleSafe(pathname) {
  useEffect(() => {
    const titles = {
      ...
      '/wissen': 'STRUKTIVA Wissen - Digitale Unternehmensstruktur fÃ¼r kleine Unternehmen',
      '/wissen/warum-eine-schoene-website-keine-kunden-bringt': 'Warum eine schÃ¶ne Website allein keine Kunden bringt - STRUKTIVA Wissen',
      '/wissen/digitale-grundsysteme-kleine-unternehmen': 'Die 5 digitalen Grundsysteme fÃ¼r kleine Unternehmen - STRUKTIVA Wissen',
    ...
    const descriptions = {
      ...
      '/wissen':
        'STRUKTIVA Wissen: praxisnahe Artikel zu Website-Struktur, Landingpages, Google-Sichtbarkeit, WhatsApp-Kontaktwegen und digitalen AblÃ¤ufen fÃ¼r kleine Unternehmen.',
      ...
      '/wissen/digitale-grundsysteme-kleine-unternehmen':
        'Die 5 digitalen Grundsysteme, die kleine Unternehmen fÃ¼r Sichtbarkeit, Vertrauen und verlÃ¤ssliche Kundenanfragen wirklich brauchen.',
      ...
      <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.02fr_0.98fr] lg:items-center">
        <div className="max-w-[40rem]">
          ...
          >
            ...
            >
              STRUKTIVA verbindet Website, Landingpage, Google-Sichtbarkeit, WhatsApp-Kontaktwege, Social Media und digitale Systeme zu einer klaren Struktur â€“ damit Kunden schneller verstehen, was du anbietest und leichter Kontakt aufnehmen.
            </motion.p>
      ...
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <SectionHeader
            ...
            text="FÃ¼r kleine Unternehmen, SelbststÃ¤ndige und lokale Dienstleister, die online professioneller auftreten mÃ¶chten."
          />
        </Reveal>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <Reveal className="mt-8">
          <div className="rounded-[1.8rem] border border-[#D8B45A]/20 bg-white/[0.05] p-6 shadow-premium md:p-7">
            ...
            <p className="mt-5 text-lg font-semibold text-[#D8B45A]">ab 199 â‚¬ zzgl. gesetzlicher Mehrwertsteuer</p>
          </div>
        </Reveal>
          ...
          <Reveal className="mt-8">
            <div className="rounded-[1.6rem] border border-white/14 bg-white/[0.05] p-6 text-center text-sm leading-7 text-[#D7DCE5]">
              ...
              <p className="mt-2">Alle Preise verstehen sich zzgl. gesetzlicher Mehrwertsteuer. Der finale Preis richtet sich nach Umfang, Seitenanzahl, Funktionen, Textaufwand, Bildern, gewÃ¼nschten Zusatzsystemen und technischer Umsetzung.</p>
              <p className="mt-2">Individuelle digitale Systeme werden nach Umfang, Betrieb und benÃ¶tigten Funktionen kalkuliert.</p>
              <a
                href={siteLinks.landingpageDigitaleStruktur}
        ...
        <div className="max-w-[41rem]">
          <motion.div initial={false} animate="visible" variants={stagger} className="flex flex-col items-start">
            ...
            <motion.h1 variants={fadeUp} transition={{ duration: 0.58, ease: [0.22, 1, 0.36, 1] }} className="mt-5 max-w-[35rem] text-3xl font-semibold tracking-tight text-white sm:text-4xl lg:text-5xl lg:leading-[1.05] xl:text-[58px]">
              Wir machen dein Unternehmen online sichtbar, verstÃ¤ndlich und anfragebereit.
            </motion.h1>
            ...
            <motion.p variants={fadeUp} transition={{ duration: 0.58, ease: [0.22, 1, 0.36, 1] }} className="mt-4 max-w-[36rem] rounded-2xl border border-white/12 bg-white/[0.04] px-4 py-3 text-sm leading-7 text-[#D7DCE5]">
              FÃ¼r kleine Unternehmen, SelbststÃ¤ndige und lokale Dienstleister, die online professioneller auftreten mÃ¶chten.
            </motion.p>
...
const wissenArticles = [
  {
    ...
    title: 'Warum eine schÃ¶ne Website allein keine Kunden bringt',
    description:
      'Viele kleine Unternehmen investieren in Design, aber nicht in KundenfÃ¼hrung. Dieser Beitrag zeigt, warum Struktur wichtiger ist als reine Optik.',
    sections: [
      {
        heading: 'Eine schÃ¶ne Website ist kein Verkaufssystem',
        text:
          'Design schafft einen ersten Eindruck. Anfragen entstehen aber erst dann, wenn Besucher sofort erkennen, was du anbietest, fÃ¼r wen dein Angebot gedacht ist und wie der nÃ¤chste Schritt aussieht.',
      },
      {
      ...
      },
      {
        ...
        text:
          'Website, Landingpage, WhatsApp-Kontaktwege, Angebotsstruktur und Google-Sichtbarkeit werden als zusammenhÃ¤ngender Ablauf aufgebaut. So wird aus Sichtbarkeit ein klarer Weg zur Anfrage.',
      },
    ],
  },
  {
    ...
    title: 'Die 5 digitalen Grundsysteme fÃ¼r kleine Unternehmen',
    description:
      'Diese fÃ¼nf Grundlagen sorgen dafÃ¼r, dass kleine Unternehmen online klar auftreten, Vertrauen aufbauen und dauerhaft anfragebereit sind.',
    sections: [
      {
        heading: '1. Website-Grundsystem',
        text:
          'Die Website erklÃ¤rt Leistungen klar, zeigt Kompetenz und fÃ¼hrt Besucher direkt zur Kontaktaufnahme.',
      },
      {
      ...
      },
      {
        ...
        text:
          'Leistungen werden in klaren Angebotsseiten strukturiert. Aktionen und Schwerpunkte laufen Ã¼ber fokussierte Landingpages.',
      },
      {
        heading: '5. Bewertungs- und Vertrauenssystem',
        text:
          'Bewertungsprozesse, Referenzlogik und konsistente Darstellung erhÃ¶hen die Abschlusswahrscheinlichkeit spÃ¼rbar.',
      },
    ],
  },
  {
    ...
    title: 'Website, Landingpage oder Funnel â€“ was braucht dein Unternehmen wirklich?',
    description:
    ...
    sections: [
      {
        heading: 'Website',
        text:
          'Die Website ist dein digitaler Hauptstandort. Sie gibt Orientierung, erklÃ¤rt Leistungen und stÃ¤rkt Vertrauen.',
      },
      {
        heading: 'Landingpage',
        text:
          'Eine Landingpage ist ideal fÃ¼r ein konkretes Angebot oder eine Kampagne. Sie fÃ¼hrt Besucher mit einem klaren Fokus zur Anfrage.',
      },
      {
        heading: 'Funnel',
        text:
          'Ein Funnel ist nur dann sinnvoll, wenn mehrere Schritte und Zielgruppen sauber strukturiert gefÃ¼hrt werden sollen.',
      },
      {
        heading: 'Was kleine Unternehmen in der Regel brauchen',
        bullets: [
          'eine professionelle Website als Basis',
          'ein bis zwei starke Landingpages fÃ¼r Kernangebote',
          'eine klare Kontaktlogik Ã¼ber WhatsApp, Telefon und Formular',
      ...
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <SectionHeader
            ...
            text="Praxisnahe BeitrÃ¤ge fÃ¼r kleine Unternehmen, SelbststÃ¤ndige und lokale Betriebe, die ihren digitalen Auftritt klarer und wirksamer strukturieren mÃ¶chten."
            centered={false}
          />
        </Reveal>
        <motion.div
      ...
      <div className="mx-auto max-w-7xl">
        <section className="rounded-[2.1rem] border border-white/14 bg-[linear-gradient(160deg,rgba(7,17,31,0.94),rgba(11,31,58,0.9),rgba(5,10,18,0.96))] p-7 shadow-premium md:p-10">
          ...
          <h1 className="mt-4 max-w-4xl text-3xl font-semibold tracking-tight text-white md:text-5xl">
            Wissen fÃ¼r digitale Unternehmensstruktur
          </h1>
          <p className="mt-4 max-w-4xl text-base leading-8 text-[#D7DCE5] md:text-lg">
            STRUKTIVA zeigt, wie kleine Unternehmen, SelbststÃ¤ndige und lokale Betriebe digitale Systeme sinnvoll aufbauen: mit Website, Landingpages, Google-Sichtbarkeit, klaren Kontaktwegen und sauberen AblÃ¤ufen.
          </p>
        </section>
      ...
      <article className="mx-auto max-w-4xl">
        <header className="rounded-[2rem] border border-white/14 bg-[linear-gradient(160deg,rgba(7,17,31,0.94),rgba(11,31,58,0.9),rgba(5,10,18,0.96))] p-7 shadow-premium md:p-10">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <a href={siteLinks.wissen} className="inline-flex items-center gap-2 rounded-full border border-[#D8B45A]/30 bg-white/[0.04] px-5 py-2.5 text-sm font-semibold text-[#D8B45A] transition hover:bg-[#D8B45A] hover:text-white">ZurÃ¼ck zu Wissen</a>
        ...
        <section className="mt-8 rounded-[1.6rem] border border-[#D8B45A]/25 bg-[linear-gradient(160deg,rgba(7,17,31,0.92),rgba(11,31,58,0.86),rgba(5,10,18,0.94))] p-6 shadow-premium">
          <p className="text-base leading-8 text-[#D7DCE5]">
            Wenn deine Website nicht nur gut aussehen, sondern fÃ¼r dein Unternehmen arbeiten soll, dann ist STRUKTIVA der richtige nÃ¤chste Schritt.
          </p>
          <a
            href={siteLinks.contact}
          ...
          >
            Digitale Struktur prÃ¼fen lassen
            <ArrowRight className="h-4 w-4" />
          </a>
        </section>
      </article>
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-8 grid gap-6">
          ...
          <ServiceSection title="Einstiegspreise fÃ¼r kleine Unternehmen">
            ...
            <p className="text-sm text-[#94A3B8]">Alle Preise verstehen sich zzgl. gesetzlicher Mehrwertsteuer. Der finale Preis richtet sich nach Umfang, Seitenanzahl, Funktionen, Textaufwand, Bildern, gewÃ¼nschten Zusatzsystemen und technischer Umsetzung.</p>
          </ServiceSection>
          ...
          <section className="rounded-[1.9rem] border border-[#D8B45A]/22 bg-[linear-gradient(160deg,rgba(7,17,31,0.92),rgba(11,31,58,0.88),rgba(5,10,18,0.95))] p-6 shadow-premium">
            ...
            <p className="mt-3 max-w-3xl text-sm leading-7 text-[#D7DCE5] md:text-base">
              Wenn du wissen mÃ¶chtest, welche digitale Struktur fÃ¼r dein Unternehmen sinnvoll ist, kannst du eine Kostenlose ErsteinschÃ¤tzung anfragen.
            </p>
        ...
        <div className="mt-8 space-y-6">
          ...
          <Reveal>
            <section className="rounded-[1.8rem] border border-[#D8B45A]/28 bg-white/[0.05] p-6 shadow-premium md:p-7">
              ...
              <p className="mt-4 text-lg font-semibold text-[#D8B45A]">Google-Bewertungssystem mit QR-Code ab 149 â‚¬ zzgl. gesetzlicher Mehrwertsteuer</p>
        ...
        <section className="mt-8 rounded-[1.8rem] border border-white/14 bg-white/[0.05] p-6 shadow-premium md:p-7">
          ...
          <div className="mt-6 rounded-2xl border border-[#D8B45A]/24 bg-white/[0.04] p-5">
            ...
            <div className="mt-3 grid gap-2 md:grid-cols-2">
              {[
                'Digitale Ordnungssysteme ab 899 â‚¬',
                'Tagesabschluss-System ab 699 â‚¬',
                'Kassenstruktur-System ab 799 â‚¬',
                'MonatsÃ¼bersicht / Export-System ab 699 â‚¬',
                'Steuerberaterfreundliche Erfassungsstruktur ab 899 â‚¬',
              ].map((item) => (
            ...
            <p className="mt-3 text-sm leading-7 text-[#94A3B8]">
              Alle Preise verstehen sich zzgl. gesetzlicher Mehrwertsteuer. Der finale Preis richtet sich nach Umfang, Seitenanzahl, Funktionen, Textaufwand, Bildern, gewÃ¼nschten Zusatzsystemen und technischer Umsetzung.
            </p>
            <p className="mt-2 text-sm leading-7 text-[#94A3B8]">
              Individuelle digitale Systeme werden nach Umfang, Betrieb und benÃ¶tigten Funktionen kalkuliert.
            </p>
          </div>
...
const websiteFormats = [
  ['Unternehmenswebsite', 'FÃ¼r kleine Unternehmen, SelbststÃ¤ndige und Dienstleister, die professionell sichtbar werden und Vertrauen aufbauen mÃ¶chten.'],
  ['Landingpage', 'FÃ¼r einzelne Angebote, Aktionen, Kampagnen oder Dienstleistungen, bei denen Besucher gezielt zur Anfrage gefÃ¼hrt werden sollen.'],
  ['Onepager', 'Eine kompakte Website auf einer Seite â€“ ideal fÃ¼r klare Angebote, lokale Dienstleister oder den schnellen professionellen Start.'],
  ['Mehrseitige Website', 'FÃ¼r Unternehmen mit mehreren Leistungen, Referenzen, Team, Preisen, Kontaktbereich und ausfÃ¼hrlicher Struktur.'],
  ['Branchenwebsite', 'Websites speziell fÃ¼r Handwerk, Beauty, Friseur, Kosmetik, Beratung, Dienstleistung oder lokale Betriebe.'],
  ['Portfolio-Website', 'FÃ¼r SelbststÃ¤ndige, Kreative, Berater oder Dienstleister, die Arbeiten, Projekte oder Referenzen hochwertig prÃ¤sentieren mÃ¶chten.'],
  ['Angebotsseite', 'FÃ¼r einzelne Leistungen oder Pakete, die klar erklÃ¤rt und verkaufsstark dargestellt werden sollen.'],
  ['Vertrauensseite', 'FÃ¼r Unternehmen, die Bewertungen, Referenzen, Vorher-Nachher-Beispiele oder QualitÃ¤t stÃ¤rker sichtbar machen mÃ¶chten.'],
  ['Termin- und Kontaktwebsite', 'FÃ¼r Betriebe, bei denen schnelle Kontaktaufnahme, WhatsApp, Telefon, Buchungsanfrage oder Terminwunsch im Mittelpunkt stehen.'],
  ['Website mit Blog oder Ratgeberbereich', 'FÃ¼r Unternehmen, die langfristig Ã¼ber Google gefunden werden mÃ¶chten und regelmÃ¤ÃŸig Inhalte verÃ¶ffentlichen wollen.'],
  ['Website mit Newsletter-Einbindung', 'FÃ¼r Unternehmen, die Interessenten sammeln, Kunden binden oder Angebote regelmÃ¤ÃŸig kommunizieren mÃ¶chten.'],
  ['Website mit QR-Code-Anbindung', 'FÃ¼r Flyer, Visitenkarten, Schaufenster, Bewertungen oder Aktionen, die direkt auf passende Seiten fÃ¼hren sollen.'],
  ['Demo-Website', 'Als Vorschau oder Konzeptseite, damit Kunden vorab sehen kÃ¶nnen, wie ihr digitaler Auftritt wirken kÃ¶nnte.'],
  ['Website-Relaunch', 'FÃ¼r bestehende Webseiten, die moderner, klarer, schneller und professioneller aufgebaut werden sollen.'],
  ['Premium-Webauftritt', 'FÃ¼r Unternehmen, die einen hochwertigen digitalen Markenauftritt mit starker Optik, klarer Struktur und Ã¼berzeugender KundenfÃ¼hrung wÃ¼nschen.'],
]

const websiteFormatsWithPrices = [
  { title: 'Unternehmenswebsite', price: 'ab 599 â‚¬', text: 'FÃ¼r kleine Unternehmen, SelbststÃ¤ndige und Dienstleister, die professionell sichtbar werden und Vertrauen aufbauen mÃ¶chten.' },
  { title: 'Landingpage', price: 'ab 299 â‚¬', text: 'FÃ¼r einzelne Angebote, Aktionen, Kampagnen oder Dienstleistungen, bei denen Besucher gezielt zur Anfrage gefÃ¼hrt werden sollen.' },
  { title: 'Onepager', price: 'ab 349 â‚¬', text: 'Eine kompakte Website auf einer Seite â€“ ideal fÃ¼r klare Angebote, lokale Dienstleister oder den schnellen professionellen Start.' },
  { title: 'Mehrseitige Website', price: 'ab 899 â‚¬', text: 'FÃ¼r Unternehmen mit mehreren Leistungen, Referenzen, Team, Preisen, Kontaktbereich und ausfÃ¼hrlicher Struktur.' },
  { title: 'Branchenwebsite', price: 'ab 749 â‚¬', text: 'Websites speziell fÃ¼r Handwerk, Beauty, Friseur, Kosmetik, Beratung, Dienstleistung oder lokale Betriebe.' },
  { title: 'Portfolio-Website', price: 'ab 499 â‚¬', text: 'FÃ¼r SelbststÃ¤ndige, Kreative, Berater oder Dienstleister, die Arbeiten, Projekte oder Referenzen hochwertig prÃ¤sentieren mÃ¶chten.' },
  { title: 'Angebotsseite', price: 'ab 249 â‚¬', text: 'FÃ¼r einzelne Leistungen oder Pakete, die klar erklÃ¤rt und verkaufsstark dargestellt werden sollen.' },
  { title: 'Vertrauensseite', price: 'ab 299 â‚¬', text: 'FÃ¼r Unternehmen, die Bewertungen, Referenzen, Vorher-Nachher-Beispiele oder QualitÃ¤t stÃ¤rker sichtbar machen mÃ¶chten.' },
  { title: 'Termin- und Kontaktwebsite', price: 'ab 399 â‚¬', text: 'FÃ¼r Betriebe, bei denen schnelle Kontaktaufnahme, WhatsApp, Telefon, Buchungsanfrage oder Terminwunsch im Mittelpunkt stehen.' },
  { title: 'Website mit Blog oder Ratgeberbereich', price: 'ab 999 â‚¬', text: 'FÃ¼r Unternehmen, die langfristig Ã¼ber Google gefunden werden mÃ¶chten und regelmÃ¤ÃŸig Inhalte verÃ¶ffentlichen wollen.' },
  { title: 'Website mit Newsletter-Einbindung', price: 'ab 699 â‚¬', text: 'FÃ¼r Unternehmen, die Interessenten sammeln, Kunden binden oder Angebote regelmÃ¤ÃŸig kommunizieren mÃ¶chten.' },
  { title: 'Website mit QR-Code-Anbindung', price: 'ab 449 â‚¬', text: 'FÃ¼r Flyer, Visitenkarten, Schaufenster, Bewertungen oder Aktionen, die direkt auf passende Seiten fÃ¼hren sollen.' },
  { title: 'Demo-Website', price: 'ab 249 â‚¬', text: 'Als Vorschau oder Konzeptseite, damit Kunden vorab sehen kÃ¶nnen, wie ihr digitaler Auftritt wirken kÃ¶nnte.' },
  { title: 'Website-Relaunch', price: 'ab 499 â‚¬', text: 'FÃ¼r bestehende Webseiten, die moderner, klarer, schneller und professioneller aufgebaut werden sollen.' },
  { title: 'Premium-Webauftritt', price: 'ab 1.499 â‚¬', text: 'FÃ¼r Unternehmen, die einen hochwertigen digitalen Markenauftritt mit starker Optik, klarer Struktur und Ã¼berzeugender KundenfÃ¼hrung wÃ¼nschen.' },
]
    ...
    <main className="px-5 pb-16 pt-10 lg:px-8 lg:pb-24 lg:pt-14">
      <div className="mx-auto max-w-6xl">
        <section className="rounded-[2.1rem] border border-[#D8B45A]/22 bg-[linear-gradient(160deg,rgba(7,17,31,0.92),rgba(11,31,58,0.88),rgba(5,10,18,0.95))] p-7 shadow-premium md:p-10">
          <h1 className="text-3xl font-semibold text-white md:text-5xl">Website fÃ¼r kleine Unternehmen professionell erstellen lassen</h1>
          <p className="mt-4 max-w-4xl text-base leading-8 text-[#D7DCE5] md:text-lg">
            STRUKTIVA entwickelt professionelle Unternehmenswebsites, Onepager, Landingpages und Relaunch-Konzepte fÃ¼r kleine Unternehmen, SelbststÃ¤ndige und lokale Dienstleister â€“ mit klarer Struktur, verstÃ¤ndlicher KundenfÃ¼hrung und mobiler Optimierung.
          </p>
          <div className="mt-7 grid gap-3 md:grid-cols-2">
            {['klare Seitenstruktur', 'professionelle Darstellung', 'mobile Optimierung', 'saubere KontaktfÃ¼hrung'].map((item) => (
        ...
        <section className="mt-8 rounded-[1.8rem] border border-white/14 bg-white/[0.05] p-6 shadow-premium md:p-7">
          ...
          <p className="mt-3 max-w-4xl text-sm leading-7 text-[#D7DCE5] md:text-base">
            Nicht jedes Unternehmen braucht dieselbe Website. STRUKTIVA entwickelt den passenden digitalen Auftritt â€“ je nach Ziel, Branche und gewÃ¼nschter Wirkung.
          </p>
          ...
          <p className="mt-6 text-sm leading-7 text-[#D7DCE5] md:text-base">
            Nicht jede Website muss groÃŸ sein. Entscheidend ist, dass sie zum Unternehmen, zum Angebot und zum Ziel passt.
          </p>
          <p className="mt-2 text-sm leading-7 text-[#D7DCE5] md:text-base">
            STRUKTIVA entwickelt Webseiten nicht als einfache Online-Visitenkarte, sondern als klare digitale Struktur: verstÃ¤ndlich, mobil optimiert, vertrauensbildend und auf Anfragen ausgerichtet.
          </p>
...
const offerPriceInfo = {
  '/website-fuer-kleine-unternehmen': {
    main: 'ab 599 â‚¬',
    extras: ['Onepager ab 349 â‚¬', 'Mehrseitige Website ab 899 â‚¬', 'Website-Relaunch ab 499 â‚¬'],
  },
  '/landingpage-erstellen-lassen': {
    main: 'ab 299 â‚¬',
    extras: ['Angebotsseite ab 249 â‚¬', 'Vertrauensseite ab 299 â‚¬'],
  },
  '/google-sichtbarkeit-kleine-unternehmen': {
    main: 'ab 349 â‚¬',
    extras: ['Google-Unternehmensprofil Einrichtung ab 249 â‚¬', 'Lokale Sichtbarkeits-Grundstruktur ab 349 â‚¬', 'Website + Google-Grundstruktur ab 699 â‚¬'],
  },
  '/digitale-kundenfuehrung': {
    main: 'ab 299 â‚¬',
    extras: ['Kontaktformular-Integration ab 149 â‚¬', 'WhatsApp-Kontaktstruktur ab 149 â‚¬'],
  },
  '/whatsapp-kontaktstruktur': {
    main: 'ab 149 â‚¬',
    extras: ['KundenfÃ¼hrungsstruktur ab 299 â‚¬'],
  },
  '/social-media-struktur': {
    main: 'ab 249 â‚¬',
    extras: ['Content-Grundstruktur fÃ¼r kleine Unternehmen ab 299 â‚¬', 'Pinterest-/Instagram-Startstruktur ab 249 â‚¬'],
  },
  '/newsletter-einbindung': {
    main: 'ab 199 â‚¬',
    extras: ['Newsletter-Grundstruktur ab 299 â‚¬'],
  },
  '/unternehmens-apps': {
    main: 'ab 999 â‚¬',
    extras: ['App-Konzept / Demo-App ab 499 â‚¬', 'Betriebs-Dashboard ab 799 â‚¬', 'Kundenverwaltungs-System ab 899 â‚¬', 'Termin-/PlanungsÃ¼bersicht ab 699 â‚¬', 'Digitale Kundenkartei ab 799 â‚¬'],
  },
  '/betriebs-dashboards': {
    main: 'ab 799 â‚¬',
    extras: ['Kundenverwaltungs-System ab 899 â‚¬', 'Termin-/PlanungsÃ¼bersicht ab 699 â‚¬'],
  },
  '/angebotsarchitektur': {
    main: 'ab 299 â‚¬',
    extras: ['Digitale Strukturberatung ab 149 â‚¬'],
  },
  '/digitale-unternehmensstruktur': {
    main: 'ab 499 â‚¬',
    extras: ['Digitale Strukturberatung ab 149 â‚¬', 'Digitale ErsteinschÃ¤tzung kostenlos'],
  },
}
...
function LeistungenPage() {
  const allLeistungPrices = {
    'Website-Erstellung': 'ab 599 â‚¬',
    Landingpages: 'ab 299 â‚¬',
    'Google-Sichtbarkeit': 'ab 349 â‚¬',
    'Digitale KundenfÃ¼hrung': 'ab 299 â‚¬',
    'WhatsApp-Kontaktstruktur': 'ab 149 â‚¬',
    'Social-Media-Struktur': 'ab 249 â‚¬',
    'Newsletter-Einbindung': 'ab 199 â‚¬',
    'Unternehmens-Apps': 'ab 999 â‚¬',
    'Betriebs-Dashboards': 'ab 799 â‚¬',
    'Digitale Ordnungssysteme': 'ab 899 â‚¬',
    Angebotsarchitektur: 'ab 299 â‚¬',
    'Beratung & ErsteinschÃ¤tzung': 'ab 149 â‚¬',
  }

  const allLeistungen = [
    ['Website-Erstellung', 'STRUKTIVA erstellt unterschiedliche Webseiten-Formate â€“ von Onepager, Unternehmenswebsite und Landingpage bis zu mehrseitigen Premium-Webauftritten, Branchenwebsites, Angebotsseiten und Websites mit Newsletter-, QR-Code- oder Kontaktstruktur.'],
    ...
    <main className="bg-[linear-gradient(180deg,#081427,#0b1f3a)] px-5 pb-16 pt-10 text-white lg:px-8 lg:pb-24 lg:pt-14">
      <div className="mx-auto max-w-7xl space-y-6">
        ...
        <DemoSectionCard title="Newsletter-Einbindung" className="border-[#334155] bg-[#0b1f3a] text-[#dbe7ff]">
          <p>Ein Newsletter kann eingebunden werden, um Interessenten regelmÃ¤ÃŸig Ã¼ber Angebote, freie Termine oder neue Leistungen zu informieren.</p>
        </DemoSectionCard>
        <DemoFinalSection />
      </div>
    </main>
