      ...
      <div className="struktiva-contact-hero__inner">
        ...
        >
          ...
          <h1 id="struktiva-contact-hero-title">
            Erzählen Sie uns, was heute nicht gut funktioniert. Die technische Lösung muss noch nicht feststehen.
          </h1>
          <div className="struktiva-contact-hero__lead">
            <p>Sie können uns schreiben, anrufen oder den Digital-Check als strukturierten Einstieg nutzen.</p>
            <p>
