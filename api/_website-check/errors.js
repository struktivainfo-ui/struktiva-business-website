const ERROR_DEFINITIONS = Object.freeze({
  ...
  WEBSITE_UNREACHABLE: [502, 'Die Website konnte nicht erreicht werden.'],
  REQUEST_TIMEOUT: [504, 'Die Website hat nicht rechtzeitig geantwortet.'],
  TOO_MANY_REDIRECTS: [422, 'Die Website-Adresse leitet zu oft weiter.'],
  REDIRECT_LOOP: [422, 'Die Website-Adresse fuehrt in eine Weiterleitungsschleife.'],
  RESPONSE_TOO_LARGE: [422, 'Die Website-Antwort ist zu gross.'],
  HTML_NOT_AVAILABLE: [422, 'Die Website hat kein unterstuetztes HTML-Dokument geliefert.'],
